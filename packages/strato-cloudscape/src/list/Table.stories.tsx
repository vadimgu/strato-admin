...
import { ResourceContext, CoreAdminContext, ListContextProvider } from 'ra-core';
...
const items = [
  ...
  { id: 4, name: 'USB-C Cable', category: 'Accessories', price: 12.50, stock: 500, lastUpdated: '2024-03-11' },
  { id: 5, name: 'Laptop Pro 14', category: 'Hardware', price: 1499.00, stock: 10, lastUpdated: '2024-03-01' },
];
