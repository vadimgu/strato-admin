...
import { PreferencesEditorContext, PreferencesEditorContextValue } from './PreferencesEditorContext';
...
export const PreferencesEditorContextProvider = ({ children }) => {
  ...
  return <PreferencesEditorContext.Provider value={context}>{children}</PreferencesEditorContext.Provider>;
};
