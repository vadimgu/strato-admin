        ...
        <AuthContext.Provider value={authProvider}>
          <QueryClientProvider client={new QueryClient()}>
            <Routes>
              ...
              <Route path="/auth-callback" element={<TestComponent />} />
            </Routes>
          </QueryClientProvider>
    ...
    render(
      <TestMemoryRouter initialEntries={['/auth-callback']}>
        <AuthContext.Provider
          value={{
            ...authProvider,
            handleCallback: () => Promise.reject(new Error('Custom Error')),
          }}
        >
          <QueryClientProvider client={new QueryClient()}>
            <Routes>
              <Route path="/" element={<div>Home</div>} />
              <Route path="/auth-callback" element={<TestComponent customError />} />
            </Routes>
          </QueryClientProvider>
        </AuthContext.Provider>
      </TestMemoryRouter>,
