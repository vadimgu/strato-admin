...
describe('usePermissions', () => {
  it('should return a loading state on mount with an authProvider that supports permissions', async () => {
    ...
    render(<WithAuthProviderAndGetPermissions authProvider={authProvider} />);
  ...
  it('should abort the request if the query is canceled', async () => {
    ...
    render(<WithAuthProviderAndGetPermissions authProvider={authProvider} queryClient={queryClient} />);
    await waitFor(() => {
