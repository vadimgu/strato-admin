...
export default {
  title: '@strato-admin/ra-core/auth/useCanAccessCallback',
};
...
export const Basic = ({ authProvider = defaultAuthProvider }: { authProvider?: AuthProvider | null }) => (
  <CoreAdminContext authProvider={authProvider != null ? authProvider : undefined}>
...
export const WithError = ({ authProvider = defaultErrorAuthProvider }: { authProvider?: AuthProvider | null }) => (
  <CoreAdminContext authProvider={authProvider != null ? authProvider : undefined}>
    <UseCanAccessCallbackComponent />
  </CoreAdminContext>
);
