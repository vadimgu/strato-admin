...
const Home = () => {
  ...
  return (
    <>
      ...
      <ul>
        <li>
          <button onClick={() => redirect('/dashboard')}>Relative url</button>
        </li>
        <li>
          <button onClick={() => redirect(() => '/dashboard')}>Relative url from a function</button>
        </li>
        <li>
          <button onClick={() => redirect('list', 'posts')}>View name</button>
        </li>
        <li>
          <button onClick={() => redirect('edit', 'posts', 123)}>View name with details</button>
        </li>
        <li>
          <button
            onClick={() =>
