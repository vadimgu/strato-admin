...
export type RouterBlocker = RouterBlockerBlocked | RouterBlockerUnblocked | RouterBlockerProceeding;
...
export interface RouterProvider {
   ...
   */
  matchPath: (pattern: string | { path: string; end?: boolean }, pathname: string) => RouterMatch | null;
