 ...
 *                        \-- data is Product
 */
export const useDeleteMany = <RecordType extends RaRecord = any, MutationError = unknown>(
  resource?: string,
  ...
  >(
    { resource, ...params },
    {
      ...
      mutationFn: ({ resource, ...params }) => {
        ...
        return dataProvider.deleteMany<RecordType>(resource, params as DeleteManyParams<RecordType>);
      },
