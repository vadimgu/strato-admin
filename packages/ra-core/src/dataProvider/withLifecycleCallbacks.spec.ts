...
describe('withLifecycleCallbacks', () => {
  ...
  describe('beforeGetList', () => {
    it('should update the getList parameters', async () => {
      ...
      const dataProvider = withLifecycleCallbacks(base, [
        {
          resource: 'posts',
          beforeGetList: jest.fn((params) => Promise.resolve({ ...params, meta: 'foo' })),
        },
      ]);
  ...
  describe('beforeGetOne', () => {
    it('should update the getOne parameters', async () => {
      ...
      const dataProvider = withLifecycleCallbacks(base, [
        {
          resource: 'posts',
          beforeGetOne: jest.fn((params) => Promise.resolve({ ...params, meta: 'foo' })),
        },
      ]);
  ...
  describe('afterGetOne', () => {
    it('should update the getOne result', async () => {
      const base = {
        getOne: jest.fn(() => Promise.resolve({ data: { id: 1, title: 'foo' } })),
      };
      const dataProvider = withLifecycleCallbacks(base, [
        {
          resource: 'posts',
  ...
  describe('beforeGetMany', () => {
    it('should update the getMany parameters', async () => {
      ...
      const dataProvider = withLifecycleCallbacks(base, [
        {
          resource: 'posts',
          beforeGetMany: jest.fn((params) => Promise.resolve({ ...params, meta: 'foo' })),
        },
      ]);
  ...
  describe('beforeGetManyReference', () => {
    it('should update the getManyReference parameters', async () => {
      ...
      const dataProvider = withLifecycleCallbacks(base, [
        {
          resource: 'posts',
          beforeGetManyReference: jest.fn((params) => Promise.resolve({ ...params, meta: 'foo' })),
        },
      ]);
  ...
  describe('beforeCreate', () => {
    it('should update the create parameters', async () => {
      ...
      const dataProvider = withLifecycleCallbacks(base, [
        {
          resource: 'posts',
          beforeCreate: jest.fn((params) => Promise.resolve({ ...params, meta: 'foo' })),
        },
      ]);
  ...
  describe('afterCreate', () => {
    it('should update the create result', async () => {
      const base = {
        create: jest.fn((resource, { data }) => Promise.resolve({ data: { id: 1, ...data } })),
      };
      const dataProvider = withLifecycleCallbacks(base, [
        {
          resource: 'posts',
  ...
  describe('beforeUpdate', () => {
    it('should update the update parameters', async () => {
      ...
      const dataProvider = withLifecycleCallbacks(base, [
        {
          resource: 'posts',
          beforeUpdate: jest.fn((params) => Promise.resolve({ ...params, meta: 'foo' })),
        },
      ]);
  ...
  describe('afterUpdate', () => {
    it('should update the update result', async () => {
      const base = {
        update: jest.fn((resource, { id, data }) => Promise.resolve({ data: { id, ...data } })),
      };
      const dataProvider = withLifecycleCallbacks(base, [
        {
          resource: 'posts',
  ...
  describe('beforeUpdateMany', () => {
    it('should update the updateMany parameters', async () => {
      ...
      const dataProvider = withLifecycleCallbacks(base, [
        {
          resource: 'posts',
          beforeUpdateMany: jest.fn((params) => Promise.resolve({ ...params, meta: 'foo' })),
        },
      ]);
  ...
  describe('afterUpdateMany', () => {
    it('should update the updateMany result', async () => {
      const base = {
        updateMany: jest.fn((resource, { ids }) => Promise.resolve({ data: ids })),
      };
      const dataProvider = withLifecycleCallbacks(base, [
        {
          resource: 'posts',
  ...
  describe('beforeSave', () => {
    it('should update the create data parameter', async () => {
      ...
      const dataProvider = withLifecycleCallbacks(base, [
        {
          resource: 'posts',
          beforeSave: jest.fn((data) => Promise.resolve({ ...data, foo: 'bar' })),
        },
      ]);
  ...
  describe('afterSave', () => {
    ...
    it('should be called on the updateMany', async () => {
      ...
      const dataProvider = withLifecycleCallbacks(base, [resourceCallback]);
  ...
  describe('beforeDelete', () => {
    it('should update the delete params', async () => {
      ...
      const dataProvider = withLifecycleCallbacks(base, [
        {
          resource: 'posts',
          beforeDelete: jest.fn((params) => Promise.resolve({ ...params, foo: 'bar' })),
        },
      ]);
  ...
  describe('afterDelete', () => {
    it('should alter the delete result', async () => {
      const base = {
        delete: jest.fn((resource, { id }) => Promise.resolve({ data: { id } })),
      };
      const dataProvider = withLifecycleCallbacks(base, [
        {
          resource: 'posts',
  ...
  describe('beforeDeleteMany', () => {
    it('should update the deleteMany params', async () => {
      ...
      const dataProvider = withLifecycleCallbacks(base, [
        {
          resource: 'posts',
          beforeDeleteMany: jest.fn((params) => Promise.resolve({ ...params, meta: 'bar' })),
        },
      ]);
  ...
  describe('afterDeleteMany', () => {
    it('should alter the deleteMany result', async () => {
      const base = {
        deleteMany: jest.fn((resource, { ids }) => Promise.resolve({ data: ids })),
      };
      const dataProvider = withLifecycleCallbacks(base, [
        {
          resource: 'posts',
      ...
      const dataProvider = withLifecycleCallbacks(base, [
        {
          resource: 'posts',
          beforeGetList: [
            jest.fn((params) => Promise.resolve({ ...params, one: 'done' })),
            jest.fn((params) => Promise.resolve({ ...params, two: 'done' })),
            jest.fn((params) => Promise.resolve({ ...params, three: 'done' })),
          ],
        },
      ]);
