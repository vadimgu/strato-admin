...
export type UseGetOneOptions<RecordType extends RaRecord = any, ErrorType = Error> = Omit<
...
export type UseGetOneHookValue<RecordType extends RaRecord = any, ErrorType = Error> = UseQueryResult<
