 ...
 * );
 */
export const withLifecycleCallbacks = (dataProvider: DataProvider, handlers: ResourceCallbacks[]): DataProvider => {
  return {
    ...dataProvider,

    getList: async function <RecordType extends RaRecord = any>(resource: string, params: GetListParams) {
    ...
    getOne: async function <RecordType extends RaRecord = any>(resource: string, params: GetOneParams<RecordType>) {
      let newParams = params;
    ...
    getMany: async function <RecordType extends RaRecord = any>(resource: string, params: GetManyParams<RecordType>) {
      let newParams = params;
    ...
    update: async function <RecordType extends RaRecord = any>(resource: string, params: UpdateParams<RecordType>) {
      let newParams = params;
    ...
    create: async function <RecordType extends RaRecord = any>(resource: string, params: CreateParams<RecordType>) {
      let newParams = params;
    ...
    delete: async function <RecordType extends RaRecord = any>(resource: string, params: DeleteParams<RecordType>) {
      let newParams = params;
    ...
    updateMany: async function <RecordType extends RaRecord = any>(
      ...
      const afterSaveHandlers = handlers.filter((h) => (h.resource === resource || h.resource === '*') && h.afterSave);
