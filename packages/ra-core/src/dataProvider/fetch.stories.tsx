...
export default {
  title: '@strato-admin/ra-core/dataProvider/fetch',
};
  ...
  return (
    ...
    >
      <p style={{ backgroundColor: '#ffb', textAlign: 'center' }}>
        <b>Tip:</b> Open the DevTools network tab to see the HTTP Headers
        <br />
        <b>Tip:</b> Open the DevTools console tab to see the returned values
      </p>
      ...
      <div style={{ display: 'flex' }}>
        <label htmlFor="header-name" style={{ flexShrink: 0, marginRight: 10 }}>
          Custom header:
        </label>
        <input
          id="header-name"
      ...
      <textarea value={record} rows={10} onChange={(e) => setRecord(e.target.value)} placeholder="body" />
