...
describe('FieldTitle', () => {
  ...
  it('should use the humanized source when given with underscores', () => {
    ...
    expect(container.firstChild.textContent).toEqual('Title with underscore');
  });
  ...
  it('should use the humanized source when given with camelCase', () => {
    ...
    expect(container.firstChild.textContent).toEqual('Title with camel case');
  });
  ...
  it('should use label rather than source', () => {
    const { container } = render(<FieldTitle label="foo" resource="posts" source="title" />);
    expect(container.firstChild.textContent).toEqual('foo');
  });
