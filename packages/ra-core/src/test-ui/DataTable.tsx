...
import { useDataTableRenderContext, DataTableRenderContext } from '../dataTable/DataTableRenderContext';
...
const DataTableHeadCell = (props: { label?: React.ReactNode; source?: string }) => {
  return (
    <th>
      {props.label ?? (
        <>
...
const DataTableCell = (props: {
  ...
  if (props.field) {
    return <td>{React.createElement(props.field, { source: props.source })}</td>;
  }
  if (props.source) {
    return (
      <td>
...
const DataTableRow = (props: { children: React.ReactNode; record?: RaRecord; resource?: string }) => {
...
export const DataTable = (
  ...
  return (
    <DataTableBase hasBulkActions={false} {...props} empty={null} loading={null}>
