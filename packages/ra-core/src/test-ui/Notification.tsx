...
export const Notification = () => {
  ...
  const [currentNotification, setCurrentNotification] = React.useState<NotificationPayload | undefined>(undefined);
  ...
  return (
    <CloseNotificationContext.Provider value={handleRequestClose}>
      ...
      >
        <p>{message && typeof message === 'string' ? translate(message, messageArgs) : message}</p>
