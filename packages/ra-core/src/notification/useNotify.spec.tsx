...
const Notify = ({ type = undefined, message, undoable, autoHideDuration, multiLine }: any) => {
...
describe('useNotify', () => {
  it('should show a multiline notification message', () => {
    render(
      <CoreAdminContext>
        <Notify type="info" message={`One Line\nTwo Lines\nThree Lines`} multiLine />
        <Notifications />
      </CoreAdminContext>,
    );
    screen.getByText(
  ...
  it('should show a notification message of type "warning"', () => {
    render(
      <CoreAdminContext>
        <Notify type="warning" message="Notification message" autoHideDuration={4000} />
        <Notifications />
      </CoreAdminContext>,
    );
    screen.getByText(
