...
import { getSimpleValidationResolver, ValidateForm } from './validation/getSimpleValidationResolver';
 ...
 */
export const useAugmentedForm = <RecordType = any>(props: UseAugmentedFormProps<RecordType>) => {
  const {
...
export type UseAugmentedFormProps<RecordType = any> = UseFormOwnProps<RecordType> &
