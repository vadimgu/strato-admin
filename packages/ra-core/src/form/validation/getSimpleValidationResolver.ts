 ...
 * );
 */
export const getSimpleValidationResolver = (validate: ValidateForm) => async (data: FieldValues) => {
...
const isRaTranslationObj = (obj: object) => Object.keys(obj).includes('message') && Object.keys(obj).includes('args');

const isEmptyObject = (obj: object) => obj == null || Object.getOwnPropertyNames(obj).length === 0;
