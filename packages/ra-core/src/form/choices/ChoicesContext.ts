 ...
 */
export const ChoicesContext = createContext<ChoicesContextValue | undefined>(undefined);
...
export interface ChoicesContextLoadingResult<
...
export interface ChoicesContextSuccessResult<
  RecordType extends RaRecord = any,
> extends ChoicesContextBaseValue<RecordType> {
  allChoices: RecordType[];
  availableChoices: RecordType[];
