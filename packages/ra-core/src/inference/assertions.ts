...
export const isInteger = (value: any) => Number.isInteger(value) || !isNaN(parseInt(value));
...
export const isBooleanString = (value: any) => ['true', 'false'].includes(value.toString().toLowerCase());
export const valuesAreBooleanString = (values: any[]) => values.every(isBooleanString);
...
export const isUrl = (value: any): value is string => !value || UrlRegexp.test(value);
...
export const isImageUrl = (value: any): value is string => !value || ImageUrlRegexp.test(value);
...
const EmailRegexp = /@{1}/;
export const isEmail = (value: any): value is string => !value || EmailRegexp.test(value);
...
export const valuesAreArray = (values: any[]): values is Array<any>[] => values.every(isArray);

export const isDate = (value: any): value is Date => !value || value instanceof Date;
export const valuesAreDate = (values: any[]): values is Date[] => values.every(isDate);

export const isDateString = (value: any): value is string =>
  !value ||
  (typeof value === 'string' &&
    (isMatch(value, 'MM/dd/yyyy') || isMatch(value, 'MM/dd/yy') || isValid(parseISO(value))));

export const valuesAreDateString = (values: any[]): values is string[] => values.every(isDateString);

export const isObject = (value: any): value is object => Object.prototype.toString.call(value) === '[object Object]';
export const valuesAreObject = (values: any[]): values is Array<object> => values.every(isObject);
