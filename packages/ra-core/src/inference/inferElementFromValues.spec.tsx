...
describe('inferElementFromValues', () => {
  ...
  it('should return a date field for date values', () => {
    ...
    expect(inferElementFromValues('foo', [new Date('2018-10-01'), new Date('2018-12-03')], types).getElement()).toEqual(
      <Good source="foo" />,
    );
  });
  ...
  it('should return a url field for url name', () => {
    ...
    expect(inferElementFromValues('url', ['whatever', 'whatever'], types).getElement()).toEqual(<Good source="url" />);
  });
  it.skip('should return a url field for url string values', () => {
    ...
    expect(
      inferElementFromValues('foo', ['http://foo.com/bar', 'https://www.foo.com/index.html#foo'], types).getElement(),
    ).toEqual(<Good source="foo" />);
  });
  ...
  it('should return a rich text field for HTML values', () => {
    ...
    expect(
      inferElementFromValues('foo', ['This is <h1>Good</h1>', '<body><h1>hello</h1>World</body>'], types).getElement(),
    ).toEqual(<Good source="foo" />);
  });
