...
import { AdminRouter, RouterProviderContext, RouterProvider, reactRouterProvider } from '../routing';
...
React-admin requires a valid dataProvider function to work.`);
  ...
  const finalDataProvider = useMemo(
    () => (dataProvider instanceof Function ? convertLegacyDataProvider(dataProvider) : dataProvider),
    [dataProvider],
  );
                ...
                <AdminRouter basename={basename}>
                  <I18nContextProvider value={i18nProvider}>
                    <NotificationContextProvider>
                      <UndoableMutationsContextProvider>
                        <ResourceDefinitionContextProvider>{children}</ResourceDefinitionContextProvider>
                      </UndoableMutationsContextProvider>
                    </NotificationContextProvider>
                  </I18nContextProvider>
                </AdminRouter>
