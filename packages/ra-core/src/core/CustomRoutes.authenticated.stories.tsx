...
export default {
  title: '@strato-admin/ra-core/core/CustomRoutes',
...
export const AuthenticatedCustomRoute = () => {
  return (
    <CoreAdmin authProvider={authProvider} dataProvider={dataProvider} loginPage={Login}>
      <CustomRoutes noLayout>
        <Route path="/authenticated" element={<CustomAuthenticatedNoLayout />} />
      </CustomRoutes>
