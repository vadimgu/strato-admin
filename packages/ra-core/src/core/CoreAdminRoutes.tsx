...
export const CoreAdminRoutes = (props: CoreAdminRoutesProps) => {
  ...
  const { customRoutesWithLayout, customRoutesWithoutLayout, status, resources } = useConfigureAdminRouterFromChildren(
    props.children,
  );
            ...
            <Layout>
              <Routes>
                ...
                <Route
                  ...
                  element={
                    dashboard ? (
                      <WithPermissions authParams={defaultAuthParams} component={dashboard} loading={LoadingPage} />
                    ) : (
                      <NavigateToFirstResource loading={LoadingPage} />
                    )
                  }
                />
                <Route path="/authentication-error" element={<AuthenticationError />} />
