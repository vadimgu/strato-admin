...
describe('useGetRecordRepresentation', () => {
  it('should return the record id by default', () => {
    render(<UseRecordRepresentation resource="users" record={{ id: 123 }} />);
  ...
  it('should return a record field if the recordRepresentation is a string', () => {
    render(
      ...
      >
        <UseRecordRepresentation resource="users" record={{ id: 123, first_name: 'John', last_name: 'Doe' }} />
      </ResourceDefinitionContextProvider>,
    );
  ...
  it('should return a deep record field if the recordRepresentation is a string with a dot', () => {
    render(
      ...
      >
        <UseRecordRepresentation resource="users" record={{ id: 123, name: { first: 'John', last: 'Doe' } }} />
      </ResourceDefinitionContextProvider>,
    );
    screen.getByText('Doe');
  });
  ...
  it('should return the record reference at fourth', () => {
    render(<UseRecordRepresentation resource="users" record={{ reference: '456', id: '123', author: 'John Doe' }} />);
    screen.getByText('456');
  });
  it('should return the record id by default', () => {
    render(<UseRecordRepresentation resource="users" record={{ id: '123', author: 'John Doe' }} />);
    screen.getByText('#123');
  });
});
