...
const PostList = () => (
  <div>
    <div>PostList</div>
    <LinkBase to="/posts/create">create</LinkBase> <LinkBase to="/posts/123">edit</LinkBase>{' '}
    <LinkBase to="/posts/123/show">show</LinkBase> <LinkBase to="/posts/customroute">custom</LinkBase>
  </div>
);
const PostEdit = () => (
  <div>
...
export const Basic = ({ navigateCallback }: { navigateCallback?: (n: RouterNavigateFunction) => void }) => (
