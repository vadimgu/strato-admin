...
import { ComponentType, useEffect, isValidElement, createElement, useState, ErrorInfo } from 'react';
import { ErrorBoundary } from 'react-error-boundary';

import { CoreAdminRoutes } from './CoreAdminRoutes';
import { useResetErrorBoundaryOnLocationChange, useRouterProvider } from '../routing';
      ...
      <ErrorBoundary
        ...
        fallbackRender={({ error, resetErrorBoundary }) => (
          <div style={{ minHeight: '100vh' }}>
            <ErrorComponent error={error} errorInfo={errorInfo} resetErrorBoundary={resetErrorBoundary} />
          </div>
        )}
      >
        <Routes>
          ...
          {LoginCallbackPage !== false && LoginCallbackPage !== true ? (
            <Route path="/auth-callback" element={createOrGetElement(LoginCallbackPage)} />
          ) : null}
