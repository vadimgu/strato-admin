...
export const ReferenceArrayInputBase = <RecordType extends RaRecord = any>(
  ...
  const { children, filter = defaultFilter, offline, reference, render, sort } = props;
  ...
  return (
    <ResourceContextProvider value={reference}>
      <ChoicesContextProvider value={controllerProps}>
        {shouldRenderOffline ? offline : render ? render(controllerProps) : children}
...
export interface ReferenceArrayInputBaseProps<RecordType extends RaRecord = any>
  extends InputProps, UseReferenceArrayInputParams<RecordType> {
