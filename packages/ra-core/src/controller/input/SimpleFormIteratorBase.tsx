...
export const SimpleFormIteratorBase = (props: SimpleFormIteratorBaseProps) => {
  ...
  const context = useMemo(
    ...
    [addField, fields.length, handleArrayClear, handleReorder, removeField, finalSource],
  );

  if (!fields) {
    return null;
  }
  return <SimpleFormIteratorContext.Provider value={context}>{children}</SimpleFormIteratorContext.Provider>;
};
