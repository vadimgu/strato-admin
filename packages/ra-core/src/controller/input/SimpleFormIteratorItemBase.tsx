...
import { SourceContextProvider, useResourceContext, useSourceContext } from '../../core';
...
export const SimpleFormIteratorItemBase = (props: SimpleFormIteratorItemBaseProps) => {
...
export type SimpleFormIteratorDisableRemoveFunction = (record: RaRecord) => boolean;

export type SimpleFormIteratorItemBaseProps = Partial<ArrayInputContextValue> & {
  children?: ReactNode;
  index: number;
  record?: RaRecord;
  resource?: string;
