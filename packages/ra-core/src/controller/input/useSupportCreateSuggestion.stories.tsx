...
export const UseSupportCreateSuggestion = (
  options: Pick<
    SupportCreateSuggestionOptions,
    'createLabel' | 'createItemLabel' | 'createValue' | 'createHintValue' | 'optionText'
  ...
  const { createId, createHintId, getCreateItem, handleChange, createElement, getOptionDisabled } =
    useSupportCreateSuggestion({
      filter,
    ...
    <CoreAdminContext dataProvider={dataProvider}>
      ...
      <form>
        <fieldset>
          ...
          <label htmlFor="autocomplete-value">Autocomplete value</label>
          &nbsp;
          <input id="autocomplete-value" value={value || ''} onChange={handleChange} />
          <button
            type="button"
            onClick={() => {
          ...
          <br />
          <label htmlFor="autocomplete-filter">Autocomplete filter</label>
          &nbsp;
          <input id="autocomplete-filter" value={filter || ''} onChange={(e) => setFilter(e.target.value)} />
        </fieldset>
      </form>
      {withCreateElement ? (
        <>
