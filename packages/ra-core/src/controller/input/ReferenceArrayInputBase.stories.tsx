...
import { ReferenceArrayInputBase, ReferenceArrayInputBaseProps } from './ReferenceArrayInputBase';
import { ChoicesContextValue, ChoicesProps, useChoicesContext } from '../../form';
...
const CheckboxGroupInput = (props: Omit<InputProps, 'source'> & ChoicesProps) => {
  const choicesContext = useChoicesContext(props);

  return <CheckboxGroupInputBase {...props} {...choicesContext} />;
};

const CheckboxGroupInputBase = (props: Omit<InputProps, 'source'> & ChoicesProps & ChoicesContextValue) => {
          ...
          <CreateBase resource="posts" record={{ tags_ids: [1, 3] }}>
            ...
            <Form>
              <ReferenceArrayInputBase
                ...
                resource="posts"
                source="tags_ids"
                queryOptions={meta ? { meta: { foo: 'bar' } } : {}}
                {...props}
              >
                <CheckboxGroupInput />
              </ReferenceArrayInputBase>
          ...
          <CreateBase resource="posts" record={{ tags_ids: [1, 3] }}>
            ...
            <Form>
              <ReferenceArrayInputBase
                ...
                queryOptions={meta ? { meta: { foo: 'bar' } } : {}}
                {...props}
                render={(context) => <CheckboxGroupInputBase {...context} source="tags_ids" />}
              />
            </Form>
          </CreateBase>
        }
      ...
      dataProvider={
        {
          ...
          getMany: () => Promise.resolve({ data: [{ id: 5, name: 'test1' }] }),
        ...
        create={
          <CreateBase resource="posts" record={{ tags_ids: [1, 3] }}>
            ...
            <Form onSubmit={() => {}} defaultValues={{ tag_ids: [1, 3] }}>
              <ReferenceArrayInputBase reference="tags" resource="posts" source="tag_ids">
                <CheckboxGroupInput />
              </ReferenceArrayInputBase>
            </Form>
          </CreateBase>
...
export const Offline = () => (
  <TestMemoryRouter initialEntries={['/posts/create']}>
    <CoreAdmin dataProvider={defaultDataProvider} i18nProvider={i18nProvider}>
      <Resource
        name="posts"
        create={
          <CreateBase resource="posts" record={{ tags_ids: [1, 3] }}>
