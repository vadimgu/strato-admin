  ...
  <TestMemoryRouter initialEntries={['/authors/1/show']}>
    ...
    >
      ...
      <Resource
        ...
        show={
          <ShowBase>
            <ReferenceManyFieldBase target="author" source="id" reference="books">
  ...
  <TestMemoryRouter initialEntries={['/books/1/show']}>
    ...
    >
      ...
      <Resource
        ...
        show={
          <ShowBase>
            <ReferenceManyFieldBase reference="authors" target="id" source="author">
...
export const WithRenderProp = ({ dataProvider = dataProviderWithAuthors }: { dataProvider?: any }) => (
  <TestMemoryRouter initialEntries={['/books/1/show']}>
    <CoreAdmin
      dataProvider={dataProvider}
      queryClient={
      ...
      >
        ...
        <Resource
          ...
          show={
            <ShowBase>
              <RenderChildOnDemand>
                <ReferenceManyFieldBase target="author" source="id" reference="books" offline={offline}>
                  <AuthorList source="title" />
                </ReferenceManyFieldBase>
              </RenderChildOnDemand>
              <p>
...
Offline.argTypes = {
  offline: {
    control: { type: 'radio' },
    options: ['let children handle offline state', 'handle offline state in ReferenceManyFieldBase'],
    mapping: {
      'let children handle offline state': undefined,
      'handle offline state in ReferenceManyFieldBase': <p>You are offline, cannot load data</p>,
    },
  },
};
