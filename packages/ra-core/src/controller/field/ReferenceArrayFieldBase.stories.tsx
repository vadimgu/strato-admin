...
export const Basic = ({ dataProvider = defaultDataProvider }: { dataProvider?: DataProvider }) => (
...
export const Loading = () => <Basic dataProvider={foreverLoadingDataProvider} />;

export const WithRenderProp = ({ dataProvider = defaultDataProvider }: { dataProvider?: DataProvider }) => (
  <TestMemoryRouter initialEntries={['/bands/1/show']}>
    <CoreAdmin
      dataProvider={dataProvider}
      queryClient={
