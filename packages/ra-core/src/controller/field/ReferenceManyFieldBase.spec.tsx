...
import { Basic, Errored, Loading, Offline, WithRenderProp } from './ReferenceManyFieldBase.stories';
  ...
  it('should pass the correct resource down to child component', async () => {
    ...
    render(
      <CoreAdminContext dataProvider={dataProvider}>
        <ReferenceManyFieldBase reference="posts" source="post_id" target="post">
          <MyComponent />
