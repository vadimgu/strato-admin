...
import { useReferenceOneFieldController, UseReferenceOneFieldControllerParams } from './useReferenceOneFieldController';
...
>(
  ...
  const controllerProps = useReferenceOneFieldController<RecordType, ReferenceRecordType>({
    record,
    reference,
    source,
    target,
  ...
  const shouldRenderEmpty =
    (!recordFromContext || (!isPaused && referenceRecord == null && !controllerError && !isPending)) &&
    empty !== false &&
    empty !== undefined;
...
export interface ReferenceOneFieldBaseProps<
  RecordType extends RaRecord = RaRecord,
  ReferenceRecordType extends RaRecord = RaRecord,
> extends UseReferenceOneFieldControllerParams<RecordType, ReferenceRecordType> {
  children?: ReactNode;
  loading?: ReactNode;
  error?: ReactNode;
  empty?: ReactNode;
