...
const BookShowQueryOptions = () => {
  ...
  return (
    <ShowBase>
      <>
        <button onClick={() => setEnabled(!enabled)}>Enable the query</button>
        <TextField source="title" />
        <ReferenceFieldBase reference="authors" source="author" queryOptions={{ enabled }}>
          <MyReferenceField>
...
const BookShowMeta = () => {
  return (
    <ShowBase>
      <TextField source="title" />
      <ReferenceFieldBase reference="authors" source="author" queryOptions={{ meta: { test: true } }}>
        <MyReferenceField>
          <TextField source="last_name" />
        </MyReferenceField>
      </ReferenceFieldBase>
    ...
    <CoreAdmin dataProvider={dataProvider}>
      <Resource
        ...
        show={() => (
          <ShowBase>
            <TextField source="title" />
            <ReferenceFieldBase reference="authors" source="author" empty={<>Should not appear</>}>
              <TextField source="first_name" />
              <TextField source="last_name" />
            </ReferenceFieldBase>
          </ShowBase>
