...
describe('CreateBase', () => {
  it('should give access to the save function', async () => {
    const dataProvider = testDataProvider({
      // @ts-ignore
      create: jest.fn((_, { data }) => Promise.resolve({ data: { id: 1, ...data } })),
    });
  ...
  it('should allow to override the onSuccess function', async () => {
    ...
    render(<NoAuthProvider dataProvider={dataProvider} mutationOptions={{ onSuccess }} />);
  ...
  it('should allow to override the onError function', async () => {
    ...
    render(<NoAuthProvider dataProvider={dataProvider} mutationOptions={{ onError }} />);
  ...
  it('should allow to override the transform function', async () => {
    ...
    const transform = jest.fn().mockReturnValueOnce({ test: 'test transformed' });

    render(<NoAuthProvider dataProvider={dataProvider} transform={transform} />);
  ...
  it('should allow to override the transform function at call time', async () => {
    ...
    const transformOverride = jest.fn().mockReturnValueOnce({ test: 'test transformed' });
