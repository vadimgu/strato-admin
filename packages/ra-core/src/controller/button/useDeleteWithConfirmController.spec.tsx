...
import useDeleteWithConfirmController, { UseDeleteWithConfirmControllerParams } from './useDeleteWithConfirmController';
    ...
    render(
      <TestMemoryRouter>
        <CoreAdminContext store={store} dataProvider={dataProvider}>
          <StoreSetter name="posts.selectedIds.storeKeys" value={['bar.selectedIds']}>
