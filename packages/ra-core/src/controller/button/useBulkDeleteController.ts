...
export const useBulkDeleteController = <RecordType extends RaRecord = any, ErrorType = Error>(
  ...
  const [deleteMany, { isPending }] = useDeleteMany<RecordType, ErrorType>(resource, undefined, {
    onSuccess: () => {
  ...
  }, [deleteMany, mutationMeta, mutationMode, otherMutationOptions, resource, selectedIds]);
