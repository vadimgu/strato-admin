 ...
 * };
 */
const useDeleteWithUndoController = <RecordType extends RaRecord = any, ErrorType = Error>(
...
> extends Omit<UseDeleteControllerParams<RecordType, MutationOptionsError>, 'mutationMode'> {
