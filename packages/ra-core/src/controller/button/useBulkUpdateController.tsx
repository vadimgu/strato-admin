...
import { useUpdateMany, UseUpdateManyOptions } from '../../dataProvider/useUpdateMany';

export const useBulkUpdateController = <RecordType extends RaRecord = any, ErrorType = Error>(
  ...
  const [updateMany, { isPending }] = useUpdateMany<RecordType, ErrorType>(resource, undefined, {
    onSuccess:
      onSuccess ??
      (() => {
  ...
  const handleUpdate = useCallback(
    ...
    [updateMany, mutationMeta, mutationMode, otherMutationOptions, resource, selectedIds],
  );
