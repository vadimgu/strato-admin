...
import { Authenticated, CanAccess, DisableAuthentication } from './useShowController.security.stories';
  ...
  it('should call the dataProvider.getOne() function on mount', async () => {
    ...
    render(
      <CoreAdminContext dataProvider={dataProvider}>
        <ShowController {...defaultProps}>{({ record }) => <div>{record && record.title}</div>}</ShowController>
      </CoreAdminContext>,
    );
    await waitFor(() => {
        ...
        <CoreAdminContext dataProvider={dataProvider}>
          <Routes>
            <Route
              path="posts/:id"
              element={
                <ShowController resource="posts" queryOptions={{ onError }}>
                  {() => <div />}
                </ShowController>
              }
            />
        ...
        <CoreAdminContext dataProvider={dataProvider}>
          <Routes>
            <Route
              path="posts/:id"
              element={
                <ShowController resource="posts" queryOptions={{ meta: { foo: 'bar' } }}>
                  {() => <div />}
                </ShowController>
              }
            />
