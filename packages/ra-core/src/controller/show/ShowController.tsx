...
import { useShowController, ShowControllerProps, ShowControllerResult } from './useShowController';
 ...
 * );
 */
export const ShowController = <RecordType extends RaRecord = any, ErrorType = Error>({
  children,
  ...props
}: {
