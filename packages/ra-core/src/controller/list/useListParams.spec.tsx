...
describe('useListParams', () => {
  ...
  describe('useListParams', () => {
    ...
    it('should synchronize parameters with location and store when sync is enabled while keeping custom query params', async () => {
      ...
      let storeValue;
      const ComponentThatSetsCustomQueryString = ({ disableSyncWithLocation = false }) => {
    ...
    it('should synchronize parameters with store when sync is not enabled and storeKey is passed', async () => {
      let storeValue;
      const Component = ({ disableSyncWithLocation = false, storeKey = undefined }) => {
        const [{ page }, { setPage }] = useListParams({
          resource: 'posts',
          disableSyncWithLocation,
          storeKey,
      ...
      render(
        <TestMemoryRouter>
          <CoreAdminContext dataProvider={testDataProvider()}>
            <Component disableSyncWithLocation storeKey="myListParams" />
            <StoreReader />
          </CoreAdminContext>
        </TestMemoryRouter>,
      );
