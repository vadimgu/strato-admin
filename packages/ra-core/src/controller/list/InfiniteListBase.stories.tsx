...
export default {
  title: '@strato-admin/ra-core/controller/list/InfiniteListBase',
};
...
const BookListView = () => {
  const { data, isPending, sort, setSort, filterValues, setFilters } = useListContext();
  if (isPending) {
...
const InfinitePagination = () => {
  const { hasNextPage, fetchNextPage, isFetchingNextPage, hasPreviousPage, fetchPreviousPage, isFetchingPreviousPage } =
...
export const AccessControl = ({
  ...
  <CoreAdminContext authProvider={authProvider} dataProvider={dataProvider}>
    <InfiniteListBase resource="books" perPage={5} authLoading={<div>Authentication loading...</div>}>
      <BookListView />
    </InfiniteListBase>
  </CoreAdminContext>
);
...
export const Loading = () => {
  ...
  const dataProvider = {
    ...
    getList: (resource, params) => {
      return new Promise<GetListResult>((resolve) => {
        resolveGetList = () => resolve(defaultDataProvider.getList(resource, params));
      });
    },
  };
  ...
  return (
    <CoreAdminContext dataProvider={dataProvider}>
      ...
      <InfiniteListBase resource="books" perPage={5} loading={<p>Loading books...</p>}>
        <BookListView />
        <InfinitePagination />
      </InfiniteListBase>
    </CoreAdminContext>
...
export const FetchError = () => {
  ...
  return (
    <CoreAdminContext dataProvider={dataProvider}>
      ...
      <InfiniteListBase resource="books" perPage={5} error={<p>Cannot load books.</p>}>
        <BookListView />
        <InfinitePagination />
      </InfiniteListBase>
    </CoreAdminContext>
...
export const Empty = () => {
  ...
  return (
    <CoreAdminContext dataProvider={dataProvider}>
      ...
      <InfiniteListBase resource="books" perPage={5} loading={<p>Loading...</p>} empty={<p>No books</p>}>
        <BookListView />
        <InfinitePagination />
      </InfiniteListBase>
    </CoreAdminContext>
