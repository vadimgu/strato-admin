...
import { Authenticated, CanAccess, DisableAuthentication } from './useListController.security.stories';
...
describe('useListController', () => {
  ...
  describe('queryOptions', () => {
    ...
    it('should accept meta in queryOptions', async () => {
      ...
      render(
        <CoreAdminContext dataProvider={dataProvider}>
          <ListController resource="posts" queryOptions={{ meta: { foo: 'bar' } }}>
            {() => <div />}
          </ListController>
        </CoreAdminContext>,
      );
    ...
    it('should reset page when enabled is set to false', async () => {
      ...
      render(
        <CoreAdminContext dataProvider={dataProvider}>
          <ListController disableSyncWithLocation queryOptions={{ enabled: false }} {...props} resource="posts" />
        </CoreAdminContext>,
      );
