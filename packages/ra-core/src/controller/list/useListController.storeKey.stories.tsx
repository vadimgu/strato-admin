...
import { CoreAdminContext, CoreAdminUI, CustomRoutes, Resource } from '../../core';
...
const OrderedPostList = ({ storeKey, sort }: { storeKey: string | false; sort?: SortPayload }) => {
...
const TopPosts = <OrderedPostList storeKey="top" sort={{ field: 'votes', order: 'DESC' }} />;
const FlopPosts = <OrderedPostList storeKey="flop" sort={{ field: 'votes', order: 'ASC' }} />;
const StorePosts = <OrderedPostList storeKey="store" sort={{ field: 'votes', order: 'ASC' }} />;
const NoStorePosts = <OrderedPostList storeKey={false} sort={{ field: 'votes', order: 'ASC' }} />;
