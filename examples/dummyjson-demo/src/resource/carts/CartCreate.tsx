import { Create, Form, NumberInput, AttributeEditor, AutocompleteInput, ReferenceInput } from 'strato-admin';
    ...
    <Create title="Add Cart">
        <Form>
            ...
            <AttributeEditor source="products" label="Products" validate={[required(), minLength(2)]}>
                ...
                <AttributeEditor.Item source="quantity" label="Quantity" field={NumberInput} validate={[required(), minValue(1)]} />
            </AttributeEditor>
        </Form>
    </Create>
);
